...
/**
 * Enum com todas as Unidades da Federação do Brasil.
 * Contém o nome da Unidade, a sigla e a capital
 * da Unidade da Federação. As unidades estão
 * listadas por ordem alfabética no enum.
 *
